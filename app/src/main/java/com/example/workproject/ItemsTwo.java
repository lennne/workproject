...
public class ItemsTwo {
    ...
    private DeviceDataTwo device_data;
    ...
    public ItemsTwo( String distance_unit_hour, String unit_of_distance, String unit_of_altitude, String unit_of_capacity, String stop_duration,
                  Integer moved_timestamp, Boolean engine_status, String icon_type, String icon_color,Sensor[] sensor, Services[] services, Tail[] tail, DeviceDataTwo device_data, IconColors icon_colors, Integer id, String name, String online, String alarm,
    ...
    public DeviceDataTwo getDevice_data() {
        return device_data;
    }

    public void setDevice_data(DeviceDataTwo device_data) {
        this.device_data = device_data;
    }
